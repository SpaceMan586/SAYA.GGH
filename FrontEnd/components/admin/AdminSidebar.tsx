...
export default function AdminSidebar({
  ...
  return (
    <aside
      className="fixed left-0 top-0 z-40 h-screen w-64 -translate-x-full border-r border-gray-200 bg-white transition-transform sm:translate-x-0 dark:border-gray-700 dark:bg-gray-800"
      aria-label="Sidebar"
    >
      <div className="h-full px-4 py-6 overflow-y-auto bg-white dark:bg-gray-800 flex flex-col">
        ...
        <ul className="space-y-2 font-medium flex-1">
          ...
          <li>
            ...
            >
              <HiDocumentText className="w-5 h-5" />{" "}
              {/* Reusing icon or import HiInbox if available, using HiDocumentText as placeholder safely or assume HiChat if available. Let's stick to known imports or add one. */}
