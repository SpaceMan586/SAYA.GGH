      ...
      <div className="absolute inset-0 -z-20 bg-gray-50">
        {heroImages.desktop && (
          <Image
            ...
            sizes="100vw"
            priority
            className="hidden md:block object-cover absolute inset-0 opacity-40 md:opacity-50 grayscale-[10%] md:grayscale-[20%]"
          />
        )}
        {heroImages.mobile && (
          <Image
            ...
            sizes="100vw"
            priority
            className="block md:hidden object-cover absolute inset-0 opacity-40 md:opacity-50 grayscale-[10%] md:grayscale-[20%]"
          />
        )}
      ...
      <div className="grid max-w-screen-xl px-6 py-12 mx-auto lg:gap-12 xl:gap-0 lg:py-24 lg:grid-cols-12 relative z-10">
        <div className="mr-auto place-self-center lg:col-span-7 p-4 md:p-12">
          ...
          <p className="max-w-2xl mb-10 font-medium text-gray-700 md:text-gray-600 lg:mb-12 text-lg md:text-xl lg:text-2xl dark:text-gray-300 leading-relaxed drop-shadow-sm">
            {customSubtitle ||
              "We build amazing experiences. Explore our projects and get in touch to learn more about what we do."}
          </p>
          <div className="flex flex-col sm:flex-row gap-4 sm:gap-6">
            <Button
              ...
              color="dark"
              size="xl"
              className="rounded-2xl px-8 shadow-xl shadow-black/10 transition-transform hover:-translate-y-1 active:scale-95 duration-300 w-full sm:w-auto"
            >
              View Projects
              <svg
            ...
            <Button
              ...
              color="gray"
              size="xl"
              className="rounded-2xl px-8 border-gray-200 transition-transform hover:-translate-y-1 active:scale-95 duration-300 bg-white/50 backdrop-blur-sm w-full sm:w-auto"
            >
              About Us
            </Button>
          </div>
        ...
        <div className="hidden lg:mt-0 lg:col-span-5 lg:flex p-12 justify-end">
          <div className="relative h-96 w-80 group rotate-6 hover:rotate-0 transition-all duration-700 ease-out">
            ...
            <div className="relative flex h-full w-full items-center justify-center bg-white/30 backdrop-blur-md dark:bg-gray-800/30 rounded-[2.5rem] border border-white/40 dark:border-gray-700 overflow-hidden shadow-2xl">
              ...
              <div className="absolute bottom-8 text-[10px] font-bold tracking-[0.4em] text-gray-600 dark:text-gray-300 uppercase z-10">
                Premium Portfolio
              </div>
            </div>
          </div>
