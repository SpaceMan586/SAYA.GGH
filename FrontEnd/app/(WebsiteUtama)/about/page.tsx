...
export default function AboutPage() {
  ...
  return (
    <>
      <main className="min-h-screen bg-white pt-32 pb-32 transition-all duration-300">
          ...
          {loading ? (
            ...
            <>
              ...
              <div className="space-y-12 mb-24 animate-in fade-in duration-1000">
                {/* Big Main Image */}
                <div className="w-full aspect-[16/7] bg-gray-200 rounded-lg overflow-hidden shadow-sm">
                  {aboutData.image_url ? (
