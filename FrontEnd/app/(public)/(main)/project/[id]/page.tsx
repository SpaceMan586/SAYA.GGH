...
export default function ProjectDetail() {
  ...
  return (
    <>
      <main className="min-h-screen bg-white pt-20 md:pt-24 pb-24 md:pb-20">
        {/* Top Navigation (Prev/Next) */}
        <div className="max-w-7xl mx-auto px-5 md:px-8 py-4 md:py-6 flex justify-between items-center text-[9px] md:text-[10px] font-bold uppercase tracking-[0.2em] md:tracking-[0.3em] text-gray-400 border-b border-gray-100 mb-6 md:mb-12">
          {nav.prev ? (
            <Link
              href={`/project/${nav.prev}`}
        ...
        <div className="max-w-7xl mx-auto px-5 md:px-8 grid grid-cols-1 lg:grid-cols-5 gap-8 lg:gap-16 pb-10 md:pb-12 items-start">
          ...
          <div className="order-1 lg:order-2 lg:col-span-3 w-full">
            <div className="relative aspect-[4/5] sm:aspect-[3/4] lg:aspect-square xl:aspect-[4/3] w-full bg-gray-50 overflow-hidden shadow-xl group rounded-2xl">
              {images.length > 0 ? (
                <>
                  ...
                  {images.length > 1 && (
                    <div className="absolute bottom-4 md:bottom-6 left-0 right-0 flex justify-center z-50 pointer-events-none">
                      <div className="flex items-center gap-5 px-4 md:px-5 py-2.5 md:py-3 rounded-full bg-black/80 backdrop-blur-md border border-white/10 shadow-2xl pointer-events-auto">
                        ...
                        <button
                          ...
                          className="p-2.5 md:p-3 -ml-1 md:-ml-2 rounded-full text-white/70 hover:text-white transition-colors active:scale-95 touch-manipulation cursor-pointer"
                        ...
                        <button
                          ...
                          className="p-2.5 md:p-3 -mr-1 md:-mr-2 rounded-full text-white/70 hover:text-white transition-colors active:scale-95 touch-manipulation cursor-pointer"
